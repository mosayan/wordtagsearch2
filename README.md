...
## 注意事項
ツールを使って画像を自分のパソコンにダウンロードし、個人で楽しむ、個人的な開発やデザインの参考資料として手元で見るといった用途であれば、日本の著作権法で認められている「私的使用」の範囲内なので問題ありません。

ダウンロードした画像を「自分のWebサイトや別のアカウントで無断転載・再配布する」「素材として販売する」「画像を利用して商売をする」といった行為は、著作権侵害になります。